...
class InvincibleEnemy(SimpleEnemy):
    ...
    def __init__(self, grid_size=(.3, .3), grid_speed=5/50, health=400):
        super().__init__(grid_size, grid_speed, health)
...
#3.2 Advanced Enemy
class AdvancedEnemy(InvincibleEnemy):
    """An enemy that can only by killed by FireTower."""
    
    name = "Advanced Enemy"
    colour = 'blue'
    points = 50

    def __init__(self, grid_size=(.5, .5), grid_speed=5/20, health=2200):
        super().__init__(grid_size, grid_speed, health)
